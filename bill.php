...
.btn-back.clicked {
    background-color: red; /* Chuyển sang màu đỏ khi đã nhấn */
    color: black; /* Chữ đen */
}
    </style>
...
<body>
    ...
    <!-- Shoping Cart Section Begin -->
        ...
        <div class="container">
            ...
            <button id="back-to-shopping" class="btn-back">Quay lại mua hàng</button>
    <!-- Shoping Cart Section End -->

    
    <script>
document.getElementById('back-to-shopping').addEventListener('click', function() {
    // Chuyển sang màu đỏ và chữ đen
    this.classList.add('clicked');

    // Chuyển hướng đến trang index.php sau 0.3 giây (thời gian hiệu ứng)
    setTimeout(() => {
